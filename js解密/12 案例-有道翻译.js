...
var navigator = {
    appVersion: "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36"
}
...
/* 目的: 获取加密参数, 然后用python调用js代码,获取加密参数,然后构建请求
* ctrl + a 全部选中
* Ctrl + shift + -  全部缩进
* */
