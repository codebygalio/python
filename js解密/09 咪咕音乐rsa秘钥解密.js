/*
* 受害者：https://www.migu.cn/
* 需求：随便输入一个账号密码之后，点击登录找到密码（enpassword）的加密方式 (rsa非对称加密),然后将关键代码扣出来
* */
navigator = {
    appVersion: "5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36"
}
window = this;
